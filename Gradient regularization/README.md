...
<p align="center"><img src="./experiment results/gradient penalty lamb 1e-05.jpg" width="49%" /><img src="./experiment results/gradient penalty lamb 1.jpg" width="49%" />(Left) $\lambda=10^{-5}$ (Right) $\lambda=1$. 1% improved.
</p>
